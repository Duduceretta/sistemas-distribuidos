...
if __name__ == "__main__":
    ...
    popula_lista1 = threading.Thread(target=popular_lista_intervalo,args=(lista1, 10000))
    popula_lista2 = threading.Thread(target=popular_lista_intervalo,args=(lista2, 10000))
