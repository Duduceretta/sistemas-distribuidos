...
class PopulaLista extends Thread {
    ...
    public void run() {
        ...
        System.out.println("lista populada: " + tamanho);
    }
}
...
public class ThreadComParametros {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        OrdenaBolha ordena1 = new OrdenaBolha(lista1, "lista1");
        OrdenaBolha ordena2 = new OrdenaBolha(lista2, "lista2");
        OrdenaBolha ordena3 = new OrdenaBolha(lista3, "lista3");
